...
<div class="bg-slate-950 text-white relative min-h-screen overflow-hidden">
          ...
          <div class="bg-gradient-to-br from-slate-900/70 to-slate-800/70 rounded-2xl p-8 border border-slate-700/50 backdrop-blur-sm hover:border-teal-500/30 transition-all duration-300">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="text-green-400 font-medium">{useCase.deployTime}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-400">AI Confidence:</span>
                <span class="text-teal-400 font-bold">{useCase.confidence}%</span>
              </div>
            </div>
          </div>
        {/each}
  ...
  <!-- Enterprise Section -->
  <section id="enterprise" class="relative z-10 py-20 px-6 bg-gradient-to-r from-slate-900/50 to-slate-800/50">
    <div class="max-w-7xl mx-auto">
      <div class="text-center mb-16">
        <h3 class="text-4xl font-bold mb-6">Enterprise-Ready from Day One</h3>
        <p class="text-xl text-gray-300 max-w-4xl mx-auto">
          Production-grade infrastructure that scales with your business needs
        </p>
      </div>

      <div class="grid md:grid-cols-3 gap-8">
        {#each enterpriseFeatures as feature}
          <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300">
  ...
  <section class="relative z-10 py-20 px-6">
    <div class="max-w-7xl mx-auto">
      <div class="text-center mb-16">
        <h3 class="text-4xl font-bold mb-6">The Future of Deployment</h3>
        <p class="text-xl text-gray-300 max-w-4xl mx-auto">
          Transform complex container orchestration into an intuitive, file-based experience
        </p>
      </div>

      <div class="bg-gradient-to-r from-slate-900/80 to-slate-800/80 rounded-3xl p-8 border border-slate-700/50">
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h4 class="text-3xl font-bold mb-8 text-red-400">Before Kyozo</h4>
            <div class="space-y-4">
              ...
              <div class="flex items-center space-x-3 text-red-400">
                <span class="text-xl">❌</span>
                <span>Hours of DevOps setup time</span>
              </div>
              <div class="flex items-center space-x-3 text-red-400">
                <span class="text-xl">❌</span>
              ...
              <div class="flex items-center space-x-3 text-red-400">
                <span class="text-xl">❌</span>
                <span>Complex monitoring setup</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="space-y-4">
              <div class="flex items-center space-x-3 text-green-400">
                <span class="text-xl">✅</span>
                <span>Drop folder → Running service</span>
              </div>
              <div class="flex items-center space-x-3 text-green-400">
                <span class="text-xl">✅</span>
              ...
              <div class="flex items-center space-x-3 text-green-400">
                <span class="text-xl">✅</span>
                <span>Built-in enterprise monitoring</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Call to Action -->
  <section class="relative z-10 py-20 px-6 bg-gradient-to-r from-teal-900/30 to-purple-900/30">
    <div class="max-w-4xl mx-auto text-center">
      <h3 class="text-5xl md:text-6xl font-bold mb-8">
        Ready to Start Your
      ...
      <div class="flex flex-col sm:flex-row justify-center gap-6 mb-16">
        ...
        <Button variant="outline" class="border-2 border-white/30 text-white px-12 py-6 rounded-xl font-bold hover:bg-white/10 transition-all text-xl backdrop-blur-sm">
          <a href="/openapi" class="flex items-center gap-3">
            📚 View Documentation
          </a>
        </Button>
      </div>
      ...
      <div class="text-center">
        ...
        <div class="flex justify-center items-center space-x-8 text-xs text-gray-500">
