defmodule Kyozo.Collaboration.Session do
  @moduledoc """
  ...
  relationships do
    ...
    has_many :operations, Kyozo.Collaboration.Operation do
      description "Operations performed in this session"
    end

    has_many :cursors, Kyozo.Collaboration.Cursor do
      description "Active cursors in this session"
    end

    has_many :presences, Kyozo.Collaboration.Presence do
