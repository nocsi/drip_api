defmodule Kyozo.Workspaces.LoadEvent do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  relationships do
    ...
    belongs_to :task, Kyozo.Workspaces.Task do
      public? true
  ...
  actions do
    ...
    create :log_found_task do
      accept [
        :path, :task_name, :task_workspace_id, :is_task_name_generated,
    ...
    create :create_generic do
      accept [
        ...
        :task_workspace_id, :is_task_name_generated, :sequence_number,
