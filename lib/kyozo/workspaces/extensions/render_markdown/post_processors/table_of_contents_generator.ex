defmodule Kyozo.Workspaces.Extensions.RenderMarkdown.PostProcessors.TableOfContentsGenerator do
  @moduledoc """
  ...
  defp generate_toc_html(grouped_headings) do
...

    {
      ...
      [
        {"id", toc_id},
        {"class", "table-of-contents bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 not-prose"},
        {"role", "navigation"},
      ...
      subsections ->
        {
          ...
          [
            h2_item,
            {
              ...
              Enum.map(subsections, &generate_toc_item(&1, "text-gray-600 hover:text-blue-600 text-sm"))
            }
          ]
        }
    end
