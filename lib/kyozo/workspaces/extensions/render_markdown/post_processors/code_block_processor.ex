defmodule Kyozo.Workspaces.Extensions.RenderMarkdown.PostProcessors.CodeBlockProcessor do
  @moduledoc """
  ...
  def process(ast, true, allowed_languages) do
    Floki.traverse_and_update(ast, fn
      ...
      {"pre", pre_attrs, [{"code", code_attrs, code_children} = code_element]} ->
        process_code_block({"pre", pre_attrs, [code_element]}, code_attrs, code_children, allowed_languages)
  ...
  defp process_code_block({"pre", pre_attrs, [{"code", code_attrs, code_children}]}, code_attrs, code_children, allowed_languages) do
  ...
  defp create_code_toolbar(language, block_id) do
    {
      "div",
      [
        {"class", "code-toolbar flex items-center justify-between bg-gray-100 border-b border-gray-200 px-4 py-2 text-sm"},
        {"role", "toolbar"},
      ...
      [
        ...
        # Copy button
        {
          ...
          [
            {"type", "button"},
            {"class", "copy-btn opacity-0 group-hover:opacity-100 transition-opacity px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"},
  ...
  defp enhance_pre_attrs(attrs, language) do
    base_classes = "bg-gray-900 text-gray-100 overflow-x-auto text-sm leading-relaxed rounded-b-lg"
  ...
  defp enhance_pre_block({"pre", attrs, children}) do
    enhanced_classes = "bg-gray-50 border border-gray-200 rounded-lg p-4 overflow-x-auto text-sm font-mono"
  ...
  defp is_programming_language?(lang) do
    programming_languages = [
      ...
      "php", "ruby", "rb", "go", "rust", "kotlin", "swift", "scala", "perl", "r", "matlab",
      "html", "css", "scss", "sass", "less", "xml", "json", "yaml", "yml", "toml", "ini",
      "bash", "shell", "sh", "zsh", "fish", "powershell", "cmd", "batch", "sql", "graphql",
      "dockerfile", "docker", "makefile", "cmake", "elixir", "ex", "exs", "erlang", "erl",
      "haskell", "hs", "ocaml", "ml", "fsharp", "fs", "clojure", "clj", "lisp", "scheme",
      "lua", "dart", "vim", "latex", "tex", "markdown", "md", "diff", "patch"
    ]
