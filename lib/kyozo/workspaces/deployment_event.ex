defmodule Kyozo.Workspaces.DeploymentEvent do
  ...
  actions do
    ...
    create :create_deployment_event do
      ...
      change {Kyozo.Workspaces.DeploymentEvent.Changes.SetWorkspaceAndTeam, []}
      change {Kyozo.Workspaces.DeploymentEvent.Changes.AssignSequenceNumber, []}
      change {Kyozo.Workspaces.DeploymentEvent.Changes.NormalizeEventData, []}

      after_action({Kyozo.Workspaces.DeploymentEvent.Changes.UpdateServiceStatus, []})
      after_action({Kyozo.Workspaces.DeploymentEvent.Changes.EmitEventNotification, []})
    end
    ...
    action :create_deployment_started, :struct do
      ...
      run {Kyozo.Workspaces.DeploymentEvent.Actions.CreateDeploymentStarted, []}
    end
    ...
    action :create_deployment_completed, :struct do
      ...
      run {Kyozo.Workspaces.DeploymentEvent.Actions.CreateDeploymentCompleted, []}
    end
    ...
    action :create_deployment_failed, :struct do
      ...
      run {Kyozo.Workspaces.DeploymentEvent.Actions.CreateDeploymentFailed, []}
    end
    ...
    action :create_service_scaled, :struct do
      ...
      run {Kyozo.Workspaces.DeploymentEvent.Actions.CreateServiceScaled, []}
    end
  end
  ...
  changes do
    change before_action({Kyozo.Workspaces.DeploymentEvent.Changes.SetDefaultOccurredAt, []}),
      on: [:create]

    change after_action({Kyozo.Workspaces.DeploymentEvent.Changes.UpdateEventMetrics, []}),
      on: [:create]
  end
  ...
  validations do
    ...
    validate {Kyozo.Workspaces.DeploymentEvent.Validations.ValidateEventData, []}
    validate {Kyozo.Workspaces.DeploymentEvent.Validations.ValidateSequenceNumber, []}
  end
  ...
  relationships do
    belongs_to :service_instance, Kyozo.Workspaces.ServiceInstance do
      allow_nil? false
