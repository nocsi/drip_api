defmodule Kyozo.Accounts.Notification do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  oban do
    triggers do
      ...
      trigger :send do
        ...
        worker_module_name Kyozo.Accounts.Notification.AshOban.Worker.Send
        scheduler_module_name Kyozo.Accounts.Notification.AshOban.Scheduler.Send
      end
    end
  end
  ...
  actions do
    ...
    update :send do
      ...
      change Kyozo.Accounts.Notification.Changes.DeliverEmail
    end
  ...
  belongs_to :sender, Kyozo.Accounts.User do
      description "The user who sent the notification"
      source_attribute :recipient_user_id
    end

    belongs_to :recipient, Kyozo.Accounts.User do
      description "The user who received the notification"
      source_attribute :recipient_user_id
    end
  end
