defmodule Kyozo.Accounts.Invitation do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  actions do
    ...
    destroy :accept_invitation do
      ...
      change before_action(fn changeset, _context ->
               ...
               Kyozo.Accounts.add_team_member!(team_member_attrs,
  ...
  relationships do
    belongs_to :invited_user, Kyozo.Accounts.User do
      public? true
      allow_nil? false
    end

    belongs_to :inviter_user, Kyozo.Accounts.User do
      public? true
      allow_nil? false
    end
