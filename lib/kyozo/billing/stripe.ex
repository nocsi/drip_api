defmodule Kyozo.Billing.Stripe do
  @moduledoc """
  ...
  Run this in production once: Kyozo.Billing.Stripe.setup_products()
  """
  def setup_products do
    # Create products
    with {:ok, _} <-
           create_product(:kyozo_api, %{
             name: "Kyozo API",
         ...
         {:ok, _} <-
           create_product(:kyozo_enterprise, %{
  ...
  defp send_subscription_welcome_email(user) do
    ...
    # TODO: Implement using Kyozo.Accounts.Emails or similar
    :ok
  end
