defmodule Kyozo.Billing.Subscription do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  actions do
    ...
    create :create_from_apple_receipt do
      ...
      change fn changeset, context ->
        ...
        case Kyozo.Billing.AppleReceiptValidator.validate_and_parse(receipt) do
          {:ok, receipt_data} ->
            changeset
  ...
  relationships do
    ...
    belongs_to :plan, Kyozo.Billing.Plan do
      allow_nil? false
      attribute_writable? true
    end

    has_many :usage_records, Kyozo.Billing.Usage
  end
