defmodule Kyozo.Containers.HealthCheck do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  validations do
    ...
    validate {Kyozo.Containers.Validations.ValidateHealthCheckEndpoint, []}
  end
  ...
  calculations do
    ...
    calculate :formatted_response_time,
              :string,
              {Kyozo.Containers.Calculations.FormatResponseTime, []}

    calculate :health_score, :decimal, {Kyozo.Containers.Calculations.HealthScore, []}
  end
