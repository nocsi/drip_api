defmodule Kyozo.Containers.DockerClient do
  @moduledoc """
  ...
  require Logger
  alias Kyozo.Containers.DockerClient.{Config, Error}
  ...
  defp build_image_from_tar(_tar_data, opts) do
    _query_params = build_build_query_params(opts)

    # This would need custom handling for streaming tar data
    # For now, return a placeholder
    {:error, Error.new(:not_implemented, "Image building from tar not yet implemented")}
  end
  ...
  defp get_config do
    Application.get_env(:kyozo, __MODULE__, @default_config)
    |> Enum.into(@default_config)
  end
end

# Error handling module
defmodule Kyozo.Containers.DockerClient.Error do
  @moduledoc """
...
defmodule Kyozo.Containers.DockerClient.Config do
  @moduledoc """
