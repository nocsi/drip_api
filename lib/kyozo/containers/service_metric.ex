defmodule Kyozo.Containers.ServiceMetric do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  validations do
    ...
    validate {Kyozo.Containers.Validations.ValidateMetricValue, []}
  ...
  calculations do
    calculate :formatted_value,
              :string,
              {Kyozo.Containers.Calculations.FormatMetricValue, []}

    calculate :is_anomaly, :boolean, {Kyozo.Containers.Calculations.MetricAnomaly, []}

    calculate :trend_direction, :atom, {Kyozo.Containers.Calculations.MetricTrend, []}
  end
