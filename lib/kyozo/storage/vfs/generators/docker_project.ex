defmodule Kyozo.Storage.VFS.Generators.DockerProject do
  ...
  defp generate_container_guide_content(context) do
    ...
    {:ok, service} = Kyozo.Services.deploy_container(
  ...
  defp generate_compose_guide_content(context) do
    ...
    {:ok, stack} = Kyozo.Services.deploy_compose(".",
      name: "#{app_name(context)}",
      env_file: ".env.production"
    )

    # Monitor services
    {:ok, status} = Kyozo.Services.stack_status(stack)
    ```
