defmodule Kyozo.Projects.Changes.ParseDocument do
    ...
    try do
      ...
      if String.trim(content) == "" do
        ...
        metadata = %{
          ...
          languages: Enum.map(created_tasks, & &1.language) |> Enum.uniq() |> Enum.reject(&is_nil/1),
