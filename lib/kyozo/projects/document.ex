defmodule Kyozo.Projects.Document do
  use Ash.Resource,
    otp_app: :kyozo,
  ...
  actions do
    ...
    create :create do
      accept [:path, :absolute_path, :filename, :name, :extension, :content, :size_bytes, :line_count, :modified_at, :metadata]
      ...
      change {Kyozo.Projects.Changes.ParseDocument, []}
    end
  ...
  validations do
    ...
    validate {Kyozo.Projects.Validations.ValidDocumentPath, []} do
