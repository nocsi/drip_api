defmodule DirupWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :dirup
  ...
  socket "/scan/websocket", DirupWeb.ScanSocket,
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :dirup
  end
  ...
  plug DirupWeb.Plugs.Init
  plug DirupWeb.Router
end
