defmodule DirupWeb.APISpec do
  ...
  alias DirupWeb.Endpoint
  alias DirupWeb.JSONAPI
  alias DirupWeb.Router
  ...
  def spec() do
    %OpenApi{
      ...
      info: %Info{
        title: to_string(Application.spec(:dirup, :description)),
        version: to_string(Application.spec(:dirup, :vsn))
      },
      ...
      components: %Components{
        ...
        schemas: %{
          ...
          "ResourceIdentifierObject" => JSONAPI.Schemas.ResourceIdentifierObject.schema(),
