defmodule DirupWeb.Live.Team.DashboardSvelte do
  ...
  defp load_teams_and_data(socket) do
    ...
    user_teams =
      case Accounts.list_user_teams(actor: current_user) do
        {:ok, teams} -> teams
        _ -> []
      end
    ...
    received_invitations =
      case Accounts.list_received_invitations(actor: current_user) do
