defmodule DirupWeb.Accounts.Groups.GroupPermissionsLive do
  ...
  def render(assigns) do
    ...
    <%!-- Group permissions --%>
    <div class="mt-4">
      <DirupWeb.Accounts.Groups.GroupPermissionForm.form
        group_id={@group_id}
        actor={@current_user}
      />
    </div>
  ...
  defp get_group(actor, group_id) do
    Ash.get!(Dirup.Accounts.Group, group_id, actor: actor)
  end
end
