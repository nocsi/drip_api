defmodule DirupWeb.Live.Containers.Dashboard do
  use DirupWeb, :live_view

  alias Dirup.Containers
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      ...
      Phoenix.PubSub.subscribe(Dirup.PubSub, "containers:#{socket.assigns.current_team.id}")
      Phoenix.PubSub.subscribe(Dirup.PubSub, "container_manager")
    end
