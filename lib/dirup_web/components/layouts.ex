defmodule DirupWeb.Layouts do
  ...
  layout on both `use DirupWeb, :controller` and
  ...
  def user_info(assigns) do
    ...
    <div class="flex space-x-3 relative items-center">
      <%= if @current_user do %>
        {live_render(@socket, DirupWeb.NotificationsLive, sticky: true, id: :notifications_container)}
