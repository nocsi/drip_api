defmodule DirupWeb.Components.Table do
  @moduledoc """
  ...
  def table(assigns) do
    assigns =
      with %{rows: %Phoenix.LiveView.LiveStream{}} <- assigns do
        ...
        |> assign(row_click: assigns.row_click && fn {_, item} -> assigns.row_click.(item) end)
      end
    ...
    <table
      class={
        classes([
          ...
          [
            "divide-y divide-background-alt dark:divide-background-alt": @show_header?
          ],
          @class
        ])
      }
