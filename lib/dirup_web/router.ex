defmodule DirupWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {DirupWeb.Layouts, :root}
  ...
  pipeline :api_authenticated do
    ...
    plug :load_from_bearer
    plug :set_actor, :user
    plug DirupWeb.Plugs.TenantAuth, :load_api_tenant
  end

  pipeline :webhook do
    plug DirupWeb.Plugs.WebhookBodyReader
    plug :accepts, ["json"]
    plug DirupWeb.Plugs.RawBody
  end

  pipeline :openapi do
    plug OpenApiSpex.Plug.PutApiSpec, module: DirupWeb.APISpec
  end
  ...
  scope "/webhooks" do
    ...
    post "/stripe", DirupWeb.Webhooks.StripeController, :webhook
    post "/apple", DirupWeb.API.BillingController, :apple_webhook
  end
  ...
  scope "/api/v1/teams/:team_id", DirupWeb.API do
    pipe_through :api_authenticated
  ...
  scope "/", DirupWeb do
    ...
    ash_authentication_live_session :authentication_optional,
      on_mount: {DirupWeb.LiveUserAuth, :live_user_optional} do
      # Landing Pages
  ...
  scope "/", DirupWeb do
    ...
    ash_authentication_live_session :authenticated_routes,
      on_mount: {DirupWeb.LiveUserAuth, :live_user_required} do
      # User Account
  ...
  scope "/", DirupWeb do
    ...
    auth_routes AuthController, Dirup.Accounts.User, path: "/auth"
    ...
    sign_in_route register_path: "/register",
                  ...
                  overrides: [DirupWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    reset_route auth_routes_prefix: "/auth",
                overrides: [DirupWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    confirm_route Dirup.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [DirupWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    magic_sign_in_route(Dirup.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [DirupWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
  ...
  if Application.compile_env(:dirup, :dev_routes) do
