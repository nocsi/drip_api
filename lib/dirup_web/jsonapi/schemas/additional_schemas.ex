defmodule DirupWeb.JSONAPI.Schemas.Timestamp do
...
defmodule DirupWeb.JSONAPI.Schemas.Meta do
  alias OpenApiSpex.Schema
...
defmodule DirupWeb.JSONAPI.Schemas.ResourceLinkage do
  alias OpenApiSpex.Schema
...
defmodule DirupWeb.JSONAPI.Schemas.ResourceIdentifierObject do
  alias OpenApiSpex.Schema
...
defmodule DirupWeb.JSONAPI.Schemas.RelationshipObject do
  alias OpenApiSpex.Schema
...
defmodule DirupWeb.JSONAPI.Schemas.Link do
  alias OpenApiSpex.Schema
