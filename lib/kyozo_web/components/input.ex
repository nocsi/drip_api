defmodule KyozoWeb.Components.Input do
  @moduledoc """
  ...
  use KyozoWeb, :component

  # import KyozoWeb.Components.Label
  # import KyozoWeb.Components.Icon

  # import KyozoWeb.Adapters.Error
