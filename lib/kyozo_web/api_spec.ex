defmodule KyozoWeb.APISpec do
  ...
  alias KyozoWeb.Endpoint
  alias KyozoWeb.JSONAPI
  alias KyozoWeb.Router
  ...
  def spec() do
    %OpenApi{
      ...
      info: %Info{
        title: to_string(Application.spec(:kyozo, :description)),
        version: to_string(Application.spec(:kyozo, :vsn))
      },
