defmodule KyozoWeb.Accounts.Groups.GroupPermissionForm do
  use KyozoWeb, :live_component

  attr :group_id, :string, required: true
  attr :actor, Kyozo.Accounts.User, required: true
  ...
  defp save_group_permissions(params, socket) do
    ...
    |> Ash.bulk_create!(
      Kyozo.Accounts.GroupPermission,
      :create,
      actor: actor,
      tenant: actor.current_team,
      return_errors?: true,
