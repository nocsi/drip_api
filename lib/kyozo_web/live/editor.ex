defmodule KyozoWeb.Live.Editor do
  ...
  def handle_event("content_changed", %{"content" => content}, socket) do
    ...
    socket =
      ...
      |> assign(:editor_content, %{word_count: 0, character_count: 0}) # You can update these from the extension
    {:noreply, socket}
  end
    ...
    sample_content = %{
      ...
      "content" => [
        ...
        %{
          "type" => "paragraph",
          "content" => [
            %{"type" => "text", "text" => "This editor is integrated with Phoenix LiveView using the "},
            %{"type" => "text", "marks" => [%{"type" => "bold"}], "text" => "LiveViewTiptapExtension"},
