defmodule KyozoWeb.Plugs.AIUsageTracking do
  @moduledoc """
  ...
  defp update_rate_limit_counters(user_id, team_id, endpoint) do
    ...
    Kyozo.RateLimit.increment_usage(user_id, endpoint)
    if team_id, do: Kyozo.RateLimit.increment_usage(team_id, endpoint)
  end
end
