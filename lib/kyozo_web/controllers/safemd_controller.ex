defmodule KyozoWeb.SafeMDController do
  @moduledoc """
  ...
  alias Kyozo.Marketing.SafeMDConfig
  ...
  defp get_usage_stats(user) do
    current_month_start = DateTime.utc_now() |> DateTime.beginning_of_month()
  ...
  defp url_for_success(user) do
    ...
    base_url = Application.get_env(:kyozo, KyozoWeb.Endpoint)[:url][:host] || "localhost:4000"
