defmodule KyozoWeb.API.DocumentsJSON do
  ...
  """
  def content(%{content: content, document: document}) do
    %{
      data: %{
        content: content,
  ...
  @doc """
  Renders document versions.
  """
  def versions(%{versions: versions, document: document}) do
    %{
      data: %{
        document_id: document.id,
        versions: versions
  ...
  @doc """
  Renders rendered document content.
  """
  def rendered_content(%{content: content, format: format, document: document}) do
    %{
      data: %{
        content: content,
        format: format,
