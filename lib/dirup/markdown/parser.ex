defmodule Dirup.Markdown.Parser do
  @moduledoc """
  ...
  alias Dirup.Markdown.Parser.{Tokenizer, ASTBuilder, KyozoEnhancer}
...
defmodule Dirup.Markdown.Parser.Tokenizer do
  @moduledoc """
...
defmodule Dirup.Markdown.Parser.ASTBuilder do
  @moduledoc """
...
defmodule Dirup.Markdown.Parser.KyozoEnhancer do
  @moduledoc """
  ...
  defp maybe_apply_metadata(%{type: :code} = node, metadata) do
    ...
    if relevant_metadata do
      ...
      Map.put(node, :data, Map.put(data, :dirup, kyozo_data))
    else
      node
    end
  end
