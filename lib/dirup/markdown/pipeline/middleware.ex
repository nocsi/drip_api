defmodule Dirup.Markdown.Pipeline.Middleware do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.InputValidator do
  @moduledoc """
  Validates input content and structure.
  """
  use Dirup.Markdown.Pipeline.Middleware
...
defmodule Dirup.Markdown.Pipeline.Middleware.UnicodeNormalizer do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.ZeroWidthStripper do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.PromptInjectionDetector do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.LinkSanitizer do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.PolyglotDetector do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.HiddenCapabilityExtractor do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.ThreatAnalyzer do
  @moduledoc """
...
defmodule Dirup.Markdown.Pipeline.Middleware.OutputSanitizer do
  @moduledoc """
