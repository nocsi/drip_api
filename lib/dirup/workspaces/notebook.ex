defmodule Dirup.Workspaces.Notebook do
  ...
  alias Dirup.Workspaces.Notebook.Changes
  ...
  relationships do
    ...
    has_many :tasks, Dirup.Workspaces.Task do
...
defmodule Dirup.Workspaces.Notebook.Cell.Config do
  use Ash.TypedStruct
...
defmodule Dirup.Workspaces.Notebook.Cell do
  use Ash.Resource,
    data_layer: :embedded,
  ...
  attributes do
    attribute :id, :uuid,
      primary_key?: true,
      allow_nil?: false,
      default: &Dirup.Workspaces.Notebook.Cell.generate_id/0

    attribute :code, :string, public?: true
    attribute :code_hash, :string, public?: true
    attribute :name, :string, public?: true
    attribute :config, Dirup.Workspaces.Notebook.Cell.Config, public?: true
  end
