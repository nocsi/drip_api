defmodule Dirup.Workspaces.Extensions.RenderMarkdown.PostProcessor do
  @moduledoc """
  ...
  alias Dirup.Workspaces.Extensions.RenderMarkdown.PostProcessors.{
    HeadingProcessor,
    ...
    Floki.traverse_and_update(ast, fn
      ...
      {"blockquote", attrs, children} ->
        new_attrs =
          add_or_update_class(
            attrs,
            "border-l-4 border-blue-500 pl-4 italic text-gray-700 bg-gray-50 py-2 my-4"
          )
      ...
      {"pre", attrs, children} ->
        new_attrs =
          add_or_update_class(
            attrs,
            "bg-gray-50 border border-gray-200 rounded-lg p-4 overflow-x-auto my-4"
          )
