defmodule Dirup.Workspaces.Extensions.RenderMarkdown.Changes.RenderMarkdown do
  @moduledoc """
  ...
  def change(changeset, opts, context) do
    ...
    Ash.Changeset.before_action(changeset, fn changeset ->
      if Ash.Changeset.changing_attribute?(changeset, source_attr) do
        ...
        add_ids? = Dirup.Workspaces.Extensions.RenderMarkdown.header_ids?(resource)

        add_table_of_contents? =
          Dirup.Workspaces.Extensions.RenderMarkdown.table_of_contents?(resource)

        syntax_highlighting? =
          Dirup.Workspaces.Extensions.RenderMarkdown.syntax_highlighting?(resource)

        allowed_languages = Dirup.Workspaces.Extensions.RenderMarkdown.allowed_languages(resource)
        mdx_options = Dirup.Workspaces.Extensions.RenderMarkdown.mdx_options(resource)
        ...
        case Dirup.Workspaces.Extensions.RenderMarkdown.as_html(source_content, render_opts) do
