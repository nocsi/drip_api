defmodule Dirup.Workspaces.FileTypeMapper do
  @moduledoc """
  ...
  alias Dirup.Workspaces.{File, FileStorage, ImageStorage}
  ...
  ## Examples
      ...
      %{
        storage_type: :file,
        storage_backend: :git,
        storage_module: Dirup.Workspaces.FileStorage,
      ...
      %{
        storage_type: :image,
        storage_backend: :s3,
        storage_module: Dirup.Workspaces.ImageStorage,
  ...
  """
  @spec determine_storage_backend(String.t(), mime_type(), storage_type(), keyword()) ::
          storage_backend()
