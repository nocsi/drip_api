defmodule Dirup.Workspaces.TopologyDetection do
  ...
  relationships do
    ...
    has_many :service_instances, Dirup.Workspaces.ServiceInstance do
      destination_attribute :diruplogy_detection_id
    end
  end
