defmodule Dirup.Workspaces.File.Relationships.PrimaryMedia do
  @moduledoc """
  ...
  alias Dirup.Workspaces.{FileMedia, Media}
  ...
  def load(files, _opts, _context) do
    ...
    media_by_file =
      ...
      |> Enum.map(fn {file_id, file_media_list} ->
        ...
        media =
          primary_file_media && primary_file_media.media_id &&
            Map.get(media_lookup, primary_file_media.media_id)
