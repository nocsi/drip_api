defmodule Dirup.Containers.ServiceDependency do
  use Ash.Resource,
    otp_app: :dirup,
  ...
  actions do
    ...
    create :create do
      ...
      change {Dirup.Containers.Changes.ValidateNoCyclicDependencies, []}
    end
  ...
  validations do
    ...
    validate {Dirup.Containers.Validations.ValidateNoDependencyLoop, []}
    validate {Dirup.Containers.Validations.ValidateEnvironmentVariable, []}
  end
  ...
  relationships do
    belongs_to :dependent_service, Dirup.Containers.ServiceInstance do
      allow_nil? false
      public? true
    end

    belongs_to :required_service, Dirup.Containers.ServiceInstance do
      allow_nil? false
      public? true
    end
  end
  ...
  calculations do
    calculate :dependency_path,
              :string,
              {Dirup.Containers.Calculations.DependencyPath, []}

    calculate :is_circular,
              :boolean,
              {Dirup.Containers.Calculations.CircularDependency, []}

    calculate :depth_level, :integer, {Dirup.Containers.Calculations.DependencyDepth, []}
  end
end
