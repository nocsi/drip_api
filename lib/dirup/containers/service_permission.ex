defmodule Dirup.Containers.ServicePermission do
  use Ash.Resource,
    otp_app: :dirup,
  ...
  actions do
    ...
    action :check_permission, :boolean do
      ...
      run {Dirup.Containers.Actions.CheckServicePermission, []}
    end
  end
  ...
  relationships do
    ...
    belongs_to :granted_by, Dirup.Accounts.User do
      public? true
    end
  end
  ...
  calculations do
    calculate :permission_scope,
              :string,
              {Dirup.Containers.Calculations.PermissionScope, []}
