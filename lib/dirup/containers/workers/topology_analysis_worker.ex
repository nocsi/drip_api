defmodule Dirup.Containers.Workers.TopologyAnalysisWorker do
  @moduledoc """
  ...
  require Logger
  alias Dirup.{Containers, Workspaces, AI}
  alias Dirup.Containers.TopologyDetection
  ...
  def enqueue(workspace_id, opts \\ []) do
    ...
    AshOban.schedule(Dirup.Containers.TopologyDetection, :analyze, args, opts)
  end
