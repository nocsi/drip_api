defmodule Dirup.Containers.ContainerManager do
  @moduledoc """
  ...
  alias Dirup.Containers.{DockerClient, ServiceInstance, DeploymentEvent}
  alias Dirup.Containers.DockerClient.Error
