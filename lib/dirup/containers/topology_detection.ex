defmodule Dirup.Containers.TopologyDetection do
  use Ash.Resource,
    otp_app: :dirup,
  ...
  actions do
    ...
    create :analyze_folder do
      ...
      change {Dirup.Containers.Changes.AnalyzeTopology, []}
  ...
  relationships do
    ...
    has_many :service_instances, Dirup.Containers.ServiceInstance do
      public? true
    end
  end
end
