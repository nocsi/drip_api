defmodule Dirup.MarkdownLD.StreamParser.Parser do
  @moduledoc """
  ...
  ## Implementation
      ...
      defmodule MyCustomParser do
        use Dirup.MarkdownLD.StreamParser.Parser
  ...
  defmacro __using__(opts \\ []) do
    quote location: :keep, bind_quoted: [opts: opts] do
      @behaviour Dirup.MarkdownLD.StreamParser.Parser
      ...
      defp parse_kyozo_directive(content) do
        case Regex.run(~r/kyozo:(\w+)(?:\s+(.+))?/, content) do
          [_, directive] ->
            {:ok, {:dirup_directive, %{type: directive, params: %{}}}}

          [_, directive, params_string] ->
            params = parse_directive_params(params_string)
            {:ok, {:dirup_directive, %{type: directive, params: params}}}
