defmodule Dirup.Storage.StorageResource do
  ...
  alias Dirup.Storage.{Upload, Locator}
  ...
  defmodule Actions do
    defmodule ScheduleBulkProcessing do
      def run(_storage_resource, input, _context) do
        ...
        case Dirup.Storage.Workers.schedule_bulk_processing(opts) do
    ...
    defmodule ScheduleMaintenance do
      def run(_storage_resource, input, _context) do
        ...
        case Dirup.Storage.Workers.schedule_bulk_processing(
    ...
    defmodule StoreContent do
      def run(_storage_resource, input, _context) do
        ...
        case Dirup.Storage.StorageResource.create_storage_entry(attrs,
               content: content,
