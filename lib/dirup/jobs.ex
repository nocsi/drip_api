defmodule Dirup.Jobs do
  ...
  def update_status(job_id, status_data) do
    ...
    Phoenix.PubSub.broadcast(Dirup.PubSub, "job:#{job_id}", {
      :job_status_update,
      %{
        job_id: job_id,
  ...
  def subscribe_to_job(job_id) do
    Phoenix.PubSub.subscribe(Dirup.PubSub, "job:#{job_id}")
  end
  ...
  def unsubscribe_from_job(job_id) do
    Phoenix.PubSub.unsubscribe(Dirup.PubSub, "job:#{job_id}")
  end
