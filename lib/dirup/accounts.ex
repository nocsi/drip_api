defmodule Dirup.Accounts do
  use Ash.Domain, otp_app: :dirup

  # GraphQL configuration removed during GraphQL cleanup

  resources do
    resource Dirup.Accounts.Token

    resource Dirup.Accounts.Team do
    ...
    resource Dirup.Accounts.UserTeam do
    ...
    resource Dirup.Accounts.Invitation do
      define :invite_user
    ...
    resource Dirup.Accounts.Group
    resource Dirup.Accounts.GroupPermission
    resource Dirup.Accounts.UserGroup

    resource Dirup.Accounts.User do
