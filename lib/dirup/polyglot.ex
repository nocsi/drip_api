defmodule Dirup.Polyglot do
  ...
  defp parse_kyozo_comment(content) do
    case Regex.run(~r/kyozo:(\w+)(?:\s+(.+))?/, content) do
      [_, type] ->
        [%{type: :dirup_directive, directive: type}]

      [_, type, params] ->
        parsed_params = parse_comment_params(params)
        [%{type: :dirup_directive, directive: type, params: parsed_params}]
  ...
  def get_transpiler(:docker), do: Dirup.Polyglot.Transpilers.Docker
  def get_transpiler(:terraform), do: Dirup.Polyglot.Transpilers.Terraform
  def get_transpiler(:kubernetes), do: Dirup.Polyglot.Transpilers.Kubernetes
  def get_transpiler(:git), do: Dirup.Polyglot.Transpilers.Git
  def get_transpiler(:bash), do: Dirup.Polyglot.Transpilers.Bash
  def get_transpiler(_), do: Dirup.Polyglot.Transpilers.Identity

  # ---- Execution ----

  def get_executor(:dockerfile), do: Dirup.Polyglot.Executors.Docker
  def get_executor(:terraform), do: Dirup.Polyglot.Executors.Terraform
  def get_executor(:kubernetes), do: Dirup.Polyglot.Executors.Kubernetes
  def get_executor(:sql), do: Dirup.Polyglot.Executors.SQL
  def get_executor(:git), do: Dirup.Polyglot.Executors.Git
  def get_executor(:executable), do: Dirup.Polyglot.Executors.Shell
  def get_executor(_), do: Dirup.Polyglot.Executors.Noop
