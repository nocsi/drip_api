defmodule Dirup.Accounts.User do
  ...
  use Ash.Resource,
    ...
    notifiers: [Dirup.Accounts.User.Notifiers.CreatePersonalTeamNotification]
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Dirup.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Dirup.Accounts.Token
      signing_secret Dirup.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Dirup.Accounts.User.Senders.SendPasswordResetEmail
      ...
      oauth2 :google do
        client_id Dirup.Secrets
        client_secret Dirup.Secrets
        redirect_uri Dirup.Secrets
        base_url Dirup.Secrets
      ...
      #   require_interaction? true
      #   sender Dirup.Accounts.User.Senders.SendMagicLinkEmail
      # end
  ...
  actions do
    ...
    #   change Dirup.Accounts.User.Oauth2
  ...
  relationships do
    many_to_many :teams, Dirup.Accounts.Team do
      through Dirup.Accounts.UserTeam
      source_attribute_on_join_resource :user_id
      destination_attribute_on_join_resource :team_id
    end

    many_to_many :groups, Dirup.Accounts.Group do
      through Dirup.Accounts.UserGroup
      source_attribute_on_join_resource :user_id
      destination_attribute_on_join_resource :group_id
    end

    has_many :valid_api_keys, Dirup.Accounts.ApiKey do
      filter expr(valid)
    end

    # many_to_many :workspaces, Dirup.Workspace.Workspacedo
    ...
    has_many :invitations, Dirup.Accounts.Invitation do
