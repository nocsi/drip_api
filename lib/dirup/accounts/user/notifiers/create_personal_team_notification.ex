defmodule Dirup.Accounts.User.Notifiers.CreatePersonalTeamNotification do
  ...
  defp create_personal_team(user) do
    ...
    team_count = Ash.count!(Dirup.Accounts.Team, authorize?: false) + 1
    ...
    case Ash.create(Dirup.Accounts.Team, team_attrs, authorize?: false) do
      {:ok, team} ->
        ...
        Ash.create!(Dirup.Accounts.UserTeam, user_team_attrs, authorize?: false)
        team
