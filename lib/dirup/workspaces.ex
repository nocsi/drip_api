defmodule Dirup.Workspaces do
  use Ash.Domain, otp_app: :dirup, extensions: [AshJsonApi.Domain]

  resources do
    resource Dirup.Workspaces.Workspace do
    ...
    resource Dirup.Workspaces.Role

    # resource Dirup.Workspaces.Document do
    ...
    resource Dirup.Workspaces.File do
      define :list_files
      define :create_file
    ...
    resource Dirup.Workspaces.FileStorage
    resource Dirup.Workspaces.ImageStorage
    resource Dirup.Workspaces.FileMedia
    resource Dirup.Workspaces.Media
    resource Dirup.Workspaces.FileNotebook

    resource Dirup.Workspaces.Notebook do
    ...
    resource Dirup.Workspaces.Blob do
      define :create_blob
    ...
    resource Dirup.Workspaces.Task do
      define :list_tasks
    ...
    resource Dirup.Workspaces.LoadEvent do
      define :list_events
      define :list_workspace_events, args: [:workspace_id]
    end

    resource Dirup.Workspaces.TopologyDetection do
    ...
    resource Dirup.Workspaces.ServiceInstance do
    ...
    resource Dirup.Workspaces.DeploymentEvent do
    ...
    resource Dirup.Workspaces.ServiceDependency do
    ...
    resource Dirup.Workspaces.DocumentBlobRef
  end
  ...
  def subscribe(topic) when is_binary(topic) do
    Phoenix.PubSub.subscribe(Dirup.PubSub, "workspace:#{topic}")
  end

  def subscribe(team_id) do
    Phoenix.PubSub.subscribe(Dirup.PubSub, "workspace:#{team_id}")
  end
end
